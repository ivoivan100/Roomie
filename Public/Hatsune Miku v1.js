...
function Loop(time = 0.2) {
    ...
    */
    ...
    higiene = higiene - parseFloat(time);
    sono = sono - parseFloat(time);
    diversao = diversao - parseFloat(time);
    social = social - parseFloat(time);
    ...
    */
    document.getElementById('fome').innerHTML = fome.toFixed(0) + '%';
    document.getElementById('higiene').innerHTML = higiene.toFixed(0) + '%';
    document.getElementById('sono').innerHTML = sono.toFixed(0) + '%';
    document.getElementById('diversao').innerHTML = diversao.toFixed(0) + '%';
